                        ...
                        <div class="row d-flex justify-content-center align-items-center mt-4">
                            <div class="col col-10">
                                ...
                                <div class="card shadow-lg bg-light ">
                                    <div class="card-body">
                                        <form action="../Operations/op_add_destination.php" method="POST">
                                            <div class="row">
                                                <div class="col">
                                                    <label for="destination_name" class="fw-semibold mb-3">Destination Name</label>
                                                    <input type="text" id="destination_name" name="destination_name" class="form-control border-dark" required>
                                                </div>
