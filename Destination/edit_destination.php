                    ...
                    <div style="height: 500px;" class="card-body pt-1">
                        <div class="row rounded-3 border border-1 border-gray shadow  d-flex align-items-center mx-0 p-3 mb-3">
                            ...
                            <div class="col col-3 text-end">
                                <a class="btn btn-success border border-1 border-dark fw-semibold" href="../Route/add_route.php">ADD
                        ...
                        <div style="max-height: 400px; overflow-y: auto;">
                            ...
                            <?php
                            try {
                                $destination_id = $_GET['id']; // Get destination ID from URL

                                $sql = "SELECT * FROM route WHERE destination_id = ?";
                            ...
                            ?>
                                        <ul class="list-group mb-1">
                                            <li class="list-group-item d-flex align-items-center justify-content-between border border-2">
                                                ...
                                                <div class="group-btn">
                                                    <a href="../Operations/op_edit_destination.php?id=<?php echo $row['route_id']; ?>" class="btn"><i class="btn btn-outline-success bi bi-pencil-square"></i></a>
